...
namespace Pharmacy_Project.Migrations
{
    ...
    partial class Pharmacy_DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.AnalysisLapsAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AnalysisLapsAppointments");
                });
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.ClincsAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.HomeSlider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.HospitalsAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HospitalsAppointments");
                });

            modelBuilder.Entity("Pharmacy_Project.Data.Entities.Medical_Information", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.MedicalCentresAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MedicalCentresAppointments");
                });
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.PharmaciesAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PharmaciesAppointments");
                });
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.XRaysAppointments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.AnalysisLapsAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.AnalysisLaps", "AnalysisLaps")
                        .WithMany("AnalysisLapsAppointments")
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.ClincsAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.Clincs", "Clincs")
                        .WithMany("ClincsAppointments")
                        .HasForeignKey("Clinc_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.HospitalsAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.Hospitals", "Hospitals")
                        .WithMany("HospitalsAppointments")
                        .HasForeignKey("Hosp_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.MedicalCentresAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.MedicalCentres", "MedicalCentres")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.PharmaciesAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.Pharmacies", "Pharmacies")
                        .WithMany("PharmaciesAppointments")
                        .HasForeignKey("Phar_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.XRaysAppointments", b =>
                {
                    b.HasOne("Pharmacy_Project.Data.Entities.Xrays", "Xrays")
                        .WithMany("XRaysAppointments")
                        .HasForeignKey("xray_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.AnalysisLaps", b =>
                {
                    b.Navigation("AnalysisLapsAppointments");
                });
            ...
            modelBuilder.Entity("Pharmacy_Project.Data.Entities.Clincs", b =>
                {
                    b.Navigation("ClincsAppointments");
                });

            modelBuilder.Entity("Pharmacy_Project.Data.Entities.Hospitals", b =>
                {
                    b.Navigation("HospitalsAppointments");
                });

            modelBuilder.Entity("Pharmacy_Project.Data.Entities.Pharmacies", b =>
                {
                    b.Navigation("PharmaciesAppointments");
                });

            modelBuilder.Entity("Pharmacy_Project.Data.Entities.Xrays", b =>
                {
                    b.Navigation("XRaysAppointments");
                });
